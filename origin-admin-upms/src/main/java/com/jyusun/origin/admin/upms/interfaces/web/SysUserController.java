...
public class SysUserController {
    ...
    public AbstractResult<PageObject<SysUserDO>> pageQuery(PageQuery pageQuery, UserInfoQuery query) {
        ...
        wrapper.eq(StringUtil.hasText(query.getUsername()), SysUserDO::getUsername, query.getUsername());
        wrapper.like(StringUtil.hasText(query.getNickname()), SysUserDO::getNickname, query.getNickname());
